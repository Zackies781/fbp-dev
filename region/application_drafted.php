...
<div id="page-wrapper">
    ...
    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="deceased_diagnosis" name="deceased_diagnosis" 
                                class="form-control" placeholder="Sila masukkan punca kematian"  
                                value="<?php echo $row_app["deceased_diagnosis"];?>"
                                Required>
                            </div>
                        </div>
                        <!-- /.col-lg-6 (nested) -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Dokumen Sokongan (Fail mestilah di dalam format PDF dan besaiz kurang daripada 5mb)
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
