...
<div id="page-wrapper">
    ...
    <div class="alert alert-danger" align="center">
        Status Permohonan: <strong>Tolak</strong> 
    </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                placeholder="Sila masukkan tarikh mati" value="<?php echo $deceased_dod;?>">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>Sijil Nikah Wakil/Penerima/Penuntut</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            <div class="form-group">
                                ...
                                placeholder="Sila masukkan nota tambahan jika ada."><?php 
                                echo $row_app["application_comments"];?></textarea>
                            </div>
                        </div>
                        <!-- /.col-lg-12 (nested) -->
                    </div>
