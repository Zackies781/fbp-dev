...
<div id="page-wrapper">
    ...
    <div class="alert alert-success" align="center">
        Status Permohonan: <strong>Permohonan Diterima</strong> 
    </div>
    <div class="row">
        <div class="col-lg-12">
    ...
    <!-- /.row -->
    <p align="center">
    <a href="print_letter.php?app=<?php echo $row_app["Id"]; ?>" class="btn btn-success" 
    target="_blank">Cetak Surat Sah Peserta</a>
    <a href="print_application.php?app=<?php echo $row_app["Id"]; ?>" class="btn btn-success" 
    target="_blank">Cetak Permohonan</a>
    <button id="etiqa" name="etiqa" type="submit" class="btn btn-warning">Hantar ke Etiqa</button>
    </p>
