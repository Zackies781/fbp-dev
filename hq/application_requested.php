...
<div id="page-wrapper">
    ...
    <div class="alert alert-info" align="center">
        Status Permohonan: <strong>Permohonan Baru</strong> 
    </div>
    <div class="row">
        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label class="radio-inline">
                                        ...
                                        value="PASANGAN" <?php if($row_app["member_relations"]=='PASANGAN'){ 
										echo 'checked'; }?>>Pasangan
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="member_relations" id="member_relations2" 
                                        value="IBU BAPA" <?php if($row_app["member_relations"]=='IBU BAPA'){ 
										echo 'checked'; }?>>Ibu Bapa
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="member_relations" id="member_relations3" 
                                        value="DIRI SENDIRI" <?php if($row_app["member_relations"]=='DIRI SENDIRI'){ 
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                           	<div class="form-group">
                                ...
                                class="btn btn-default btn-lg btn-block btn-sm" target="_blank">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                class="btn btn-default btn-lg btn-block btn-sm" target="_blank">
                                Cetak Sijil Nikah Wakil/Penerima/Penuntut</a>
                            </div>
                        </div>
                        <!-- /.col-lg-6 (nested) -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12" align="center">
                            <div class="form-group" align="center">
                                <label>Nota</label>
                                <textarea id="application_comments" name="application_comments" 
                                class="form-control" rows="4" 
                                placeholder="Sila masukkan nota tambahan jika ada."
                                onKeyUp="enableButton()"><?php echo $row_app["application_comments"];?></textarea>
                            </div>
                        </div>
                        <!-- /.col-lg-12 (nested) -->
                    </div>
    ...
    <!-- /.row -->
    <p align="center">
    <button id="verify" name="verify" type="submit" class="btn btn-success">
    <i class="fa fa-pencil"></i>    Terima  </button>
    <button id="reject" name="reject" type="submit" class="btn btn-danger" disabled>
    <i class="fa fa-exclamation"></i>    Tidak Lengkap  </button>
    </p>
...
<!-- InstanceBeginEditable name="javascript" -->
    ...
    <!-- Disable button if note empty -->
    <script>
	function enableButton() {
		var textarea_value = document.getElementById("application_comments").value;
		if(textarea_value != '') {
