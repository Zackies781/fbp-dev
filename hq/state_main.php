...
//List all territory
$sql = "SELECT s.id, s.code, s.name, t.name as territory
FROM fbp_state s  LEFT JOIN fbp_territory t ON s.territory_id = t.id
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Negeri</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
						 	...
						 	<?php if ($result->num_rows > 0) {
								...
								while($row = $result->fetch_assoc()) { 
									...
									'<tr class="odd gradeX">
										...
										<td><p class="text-uppercase"">'.$row["territory"].'</p></td>
									</tr>';
                            	}	
							}?>
                      		</tbody>
