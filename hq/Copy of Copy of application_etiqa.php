...
<div id="page-wrapper">
    ...
    <div class="alert alert-warning" align="center">
        Status Permohonan: <strong>Proses Etiqa</strong> 
    </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                value="<?php echo $row_app["comp_etiqa_no"];?>" required>
                            </div>
                            <div class="form-group">
                                <label for="dtp_input" class="control-label">Tarikh Cek ETIQA</label>
                                <div class="input-group date form_date" data-date="" data-date-format="dd-mm-yyyy"
                                 data-link-field="dtp_input" data-link-format="yyyy-mm-dd">
                                <input class="form-control" type="text" id="etiqa_date" name="etiqa_date"
                                placeholder="Sila masukkan tarikh cek Etiqa" value="<?php echo $etiqa_date;?>" required>
                        	...
                        	<div class="form-group">
                                ...
                                value="<?php echo $row_app["comp_value"];?>" required>
                            </div>
                        </div>
                        <!-- /.col-lg-6 (nested) -->
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="dtp_input2" class="control-label">Tarikh Cek FBP</label>
                                <div class="input-group date form_date" data-date="" data-date-format="dd-mm-yyyy"
                                 data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                <input class="form-control" type="text" id="fbp_date" name="fbp_date"
                                placeholder="Sila masukkan tarikh cek FBP" value="<?php echo $fbp_date;?>">
                                <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span></span>
                                </div>
                        	</div>
    ...
    <!-- /.row -->
    <p align="center">
    <button id="save_check" name="save_check" type="submit" class="btn btn-warning">Simpan</button>
    <button id="complete" name="complete" type="submit" class="btn btn-success">Selesai</button>
    </p>
