...
//List all territory
$sql = "SELECT p.id, p.code, p.name, r.code as region_code, r.name as region_name, s.code as state_code, s.name as state_name, t.code as territory_code, t.name as territory_name
FROM fbp_project p
LEFT JOIN fbp_region r ON p.region_code = r.code
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Enter text" value="<?php echo $row["region_code"];?>">
                                </div>
                        </div>
                        <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Kawasan</label>
                                    <input class="form-control" placeholder="Enter text" value="<?php echo $row["region_name"];?>">
                                </div>
                        </div>
                        <!-- /.col-lg-6 (nested) -->
                                                 <div class="col-lg-6">
