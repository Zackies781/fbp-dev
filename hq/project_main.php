...
//List all territory
$sql = "SELECT p.id, p.code, p.name, r.name as region_name, s.name as state_name, t.name as territory_name
FROM fbp_project p
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Projek</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
						 	...
						 	<?php if ($result->num_rows > 0) {
								...
								while($row = $result->fetch_assoc()) { 
									...
									'<tr class="odd gradeX">
										...
										<td><p class="text-uppercase"">'.$row["region_name"].'</p></td>
										<td><p class="text-uppercase"">'.$row["state_name"].'</p></td>
										<td>
											<div class="tooltip-demo">
											<a href="project_detail.php?pid='.$row["id"].'">
