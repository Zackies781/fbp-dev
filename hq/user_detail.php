...
//List all territory
$sql = "SELECT u.id, u.user_fullname, u.username, u.password, u.user_ic, u.user_tel_mobile, u.user_territory_id, u.user_region_id, u.user_access, u.user_email, r.name as user_region, t.name as user_territory
FROM fbp_user u
...
<div id="page-wrapper">
    ...
    <p align="center">
        <button id="reset" name="reset" type="submit" class="btn btn-success"  
        onclick="location.href='user_password.php?user=<?php echo $row["id"]; ?>'">
        <i class="fa fa-refresh"></i>    Tukar Kata Laluan  </button>
        <button id="update" name="update" type="submit" class="btn btn-primary"  
        onclick="location.href='user_edit.php?user=<?php echo $row["id"]; ?>'">
